...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`PLR BRASIL`}</title>

        <meta
          name="description"
          content="Welcome to PLR BRASIL - Your ultimate destination for digital marketing, PLR, and dropshipping solutions. Empowering your business growth."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661956600684-97d3a4320e45?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwbWFya2V0aW5nfGVufDB8fHx8MTY5MTI3ODcyNnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to PLR BRASIL - Your ultimate destination for digital marketing, PLR, and dropshipping solutions. Empowering your business growth.`}
            </Text>
            <Box
